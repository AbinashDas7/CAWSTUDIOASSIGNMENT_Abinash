...
Implemented a Maven structured framework.
Utilized the Page Object Model mechanism to drive locators from respective classes.
Encapsulated object creation within page object classes, ensuring encapsulation from tests.
Created a base test class responsible for setting browser configuration details and global properties from a properties file.
Introduced grouping in TestNG.xml to categorize tests.
